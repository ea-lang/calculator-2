...
while True:
    ...
    if input_string.lower() == "q" or input_string.lower() == "quit":
        ...
        print add(int(input_list[1]), int(input_list[2]))   
    
    elif input_list[0] == "-":
        print subtract(int(input_list[1]), int(input_list[2]))
    
    elif input_list[0] == "*":
        print multiply(int(input_list[1]),int(input_list[2]))
        ...
        print divide(int(input_list[1]), int(input_list[2]))
